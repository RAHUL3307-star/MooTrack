...
const LOCAL_ALERTS: AlertItem[] = [
  {
    ...
    animal_id: "KA-001",
    risk_level: "high",
    message: "Cow 1 — Milk EC critical: 9.4 mS/cm, pH 7.35. Teat temp 39.4°C. Immediate teat inspection required.",
    status: "active",
    urgency: "Immediate",
  ...
  },
  {
    ...
    animal_id: "KA-052",
    risk_level: "high",
    message: "Cow 8 — Milk EC 9.8 mS/cm, pH 7.42. Clinical mastitis. Veterinary escalation required.",
    status: "active",
    urgency: "Critical",
  ...
  },
  {
    ...
    animal_id: "KA-007",
    risk_level: "moderate",
    message: "Cow 2 — Rising conductivity trend (6.8 mS/cm), pH 6.95. Pre-milking teat dipping recommended.",
    status: "active",
    urgency: "Monitor",
