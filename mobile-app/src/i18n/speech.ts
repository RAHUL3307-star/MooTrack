...
export const SCREEN_SPEECH: Record<string, (lang: string) => string> = {
  ...
  profile: (lang: string) => {
    switch (lang) {
      ...
      default:
        return "Profile summary. Shri Balaji Dairy Farm, managed by Ramesh Patel. Registered cattle with active milk production. Your official veterinarian is Dr. Sharma. You can change your preferred language below anytime.";
    }
  },
