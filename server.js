...
void loop() {
  ...
  if (reqPath.startsWith('/app/assets/')) {
    reqPath = reqPath.replace('/app/assets/', '/assets/');
  } else if (reqPath.startsWith('/app/samples/')) {
    reqPath = reqPath.replace('/app/samples/', '/samples/');
  } else if (reqPath === '/app/manifest.json') {
    reqPath = '/manifest.json';
  } else if (reqPath === '/app/sw.js') {
    reqPath = '/sw.js';
  } else if (reqPath.startsWith('/app/icon')) {
    reqPath = reqPath.replace('/app/', '/');
  }

  if (reqPath === '/' || reqPath === '') reqPath = '/index.html';
  if (reqPath === '/dashboard' || reqPath === '/app' || reqPath === '/app/' || reqPath === '/mobile' || reqPath === '/mobile/' || reqPath === '/app/index.html') {
    reqPath = '/mobile.html';
  }
